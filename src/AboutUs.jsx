  ...
  return (
    <div className="flex justify-center lg:justify-start my-auto">
      <img
        ...
        decoding="async"
        fetchpriority="high"
        className="mt-5 rounded-full size-35 md:size-60 lg:size-70 xl:size-86"
        alt="About Us"
      />
    </div>
  );
...
function ServiceDesc() {
  return (
    <div className="text-zinc-900 p-5">
      <h2 className="text-4xl my-3 theseasons-bold">About Us</h2>
      <h3 className="text-3xl lg:text-5xl my-5 aileron-heavy">
        <TypewriterOnScroll
          strings={["Amerta By Kartini"]}
          options={{
            delay: 40,
            loop: true,
          }}
        ...
        <span className="inline">
          specializes in creating stylish and personalized mini events.
        </span>
      </h3>
      <p className="text-xl lg:text-2xl my-2 montserrat">
        Starting from artistic design and collaboration, we offer custom decor
        services that elevate each event with thoughtful detail.
      </p>
    </div>
  );
}
