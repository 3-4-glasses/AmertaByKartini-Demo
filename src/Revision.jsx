...
function App() {
    ...
    return (
        <div className="flex flex-wrap bg-yellow-100 pt-[30vh] min-h-screen">
          <div className="container mx-auto flex flex-col items-center bg-orange-50 shadow-lg w-1/2 p-4">
